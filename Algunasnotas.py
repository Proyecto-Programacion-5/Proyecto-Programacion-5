...
#Esta funcion se encarga de generar todas las cordenadas de 2 puntos que hacen referencia a cada cuadro del buscaminas
...
#Esta funcion, usando la libreria random,se encarga de colocar al azar en 1/5 de los cuadros generados en la funcion HacerCuadricula una mina           
def Colocarminas(c):
    c_dict = {}
    for i in c:
...
#Esta funcion se encarga de buscar los cuadros que no poseen minas y agrgarles un numero el cual representa la cantidad de minas que que ese cuadro poee a sus alrededores        
